<%-- 
    Document   : autor
    Created on : 04-22-2018, 07:33:14 PM
    Author     : karin
--%>
...
<html>
    ...
    <body>
        ...
        <!--contenedor-->
        <div style="width:95%; height:1100px; background-color:#f3e8e8ab; margin:0 auto; margin-top:110px; padding: 10px">
            
            <br>
            <h1 style="position: relative; top: -10px; left: 816px;">Autor</h1>
            ...
            <div  class="container">
                <div>
                    ...
                    <tbody>
                        <%
                        st = conexion.prepareStatement("select idAutor, Nombre_Autor, Codigo_Material from autor");
                        rs = st.executeQuery();
                        while (rs.next()) 
                        {
                        %>
                        <tr>
                            <td><center><%=rs.getString("idAutor")%></center></td>
                            <td><center><%=rs.getString("Nombre_Autor")%></center></td>
                ...
                <div class="row col-md-8" style="position: relative; top: 30px; left: 650px; width: 80%">
                    <form action="ingresar.jsp" method="POST">
                        <fieldset style="background-color: #c0c0c0; border: 3px solid white; width: 386px; height: 310px;">
                            ...
                            <legend align="center" style="float: right; border: 2px solid white; "> Autores</legend>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <br>
                                    &nbsp
                                    <b><label for="nombre"> Nombre del autor: </label></b>
                                     <div align="center" class="input-group">
                                        <input  type="text" class="form-control" id="nombre" name="nombre"
                                       placeholder="Ingresa el nombre del Autor"   style="font-family: Comic Sans MS;   width:310px; ">
