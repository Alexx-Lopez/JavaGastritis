...
<html>
    ...
    <body>
        ...
        <div id="search" class="page-section" style="width:90%; height:600px; background-color:white; margin:0 auto; margin-top:200px;">
            <span>
                <h2 style="text-align:center;"><fmt:message key="i_lbl_busq"/></h2>
            </span>
            <br>
            <center>
                <image src="https://cdn4.iconfinder.com/data/icons/imod/256/Software/iChat-top-delire.png">
            </center>
            <br>
            <center>
                <button type="sumit" class="btn btn-info">
                    <b><a href="realizar_consulta.jsp"><fmt:message key="i_lbl_cons"/></a></b>
                </button>
            </center>
        </div>
