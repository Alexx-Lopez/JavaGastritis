<%-- 
    Document   : Mantenimiento_Empleado
    Created on : 10-may-2018, 2:43:54
    Author     : Alexx
--%>
...
<!--Consulta SQL para alimentar el select turno-->
<sql:query dataSource="jdbc/mysql" var="consulta_turno">
    select * from turno
</sql:query>    
    
<!--Consulta SQL para alimentar el select cargo-->
    ...
    <body onload="iniciar();">
        ...
        <form name="datos" role="form" action="Consultas_Empleado.jsp" method="POST" accept-charset="ISO-8859-1">
            <div style="width:95%; height:auto; background-color:#f3e8e8ab; margin:0 auto; margin-top:110px; padding: 10px; z-index:10;">
                        ...
                        <tr>
                            <td align="center">
                                <div class="input-group"  style="width:80%">
                                    <input type="text" class="form-control" id="txt_hora_inicio" name="txt_hora_inicio" value="" disabled>
                                    <span class="input-group-addon"><i class="material-icons" style="font-size:18px">schedule</i></span>
                                </div>
                            </td>
                            <td align="center">
                                <div class="input-group"  style="width:80%">
                                    <input type="text" class="form-control" id="txt_hora_fin" name="txt_hora_fin" value="" disabled>
                                    <span class="input-group-addon"><i class="material-icons" style="font-size:18px">schedule</i></span>
                                </div>
                            </td>
                        </tr>
                ...
                <br>
                <div class="panel-group" style="width:100%; margin:0 auto;">
                                    ...
                                    <tbody>
                                        <c:forEach var="name" items="${consulta.rows}">
                                            <tr>
                                                ...
                                                <td align="center"><c:out value="${name.Apellido}"/></td>
                                                <td align="center"><c:out value="${name.Email}"/></td>
                                                <td align="center"><c:out value="${name.Telefono}"/></td>
                                                <td align="center"><c:out value="${name.DUI}"/></td>
                                                <td align="center"><c:out value="${name.NIT}"/></td>
                                                <td align="center"><c:out value="${name.Salario}"/></td>
