<%-- 
    ...
    Created on : 22-abr-2018, 10:21:38
    Author     : Alexx
--%>
...
<html>
    ...
    <body>
        ...
        <div style="width:95%; min-height:550px; background-color:#f3e8e8ab; margin:0 auto; margin-top:20px; padding: 10px; color:white;">
            <div class="layout" style="margin: 0 auto;">
                <div id="freewall" class="free-wall">

                    <div class="cell size32" style="background-color:rgb(58, 13, 130);" data-position="0-0" data-handle=".handle">
                        <div class='cover'>
                            <div class="handle">
                    ...
                    <div class='cell size32' style="background-color:#078e88;" data-position="0-5" data-handle=".handle">
                        <div class='cover'>
                            <div class="handle">
                                <span class="material-icons">open_with</span>
                            </div>
