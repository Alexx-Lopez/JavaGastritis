<%-- 
    ...
    Created on : 04-22-2018, 07:37:16 PM
    Author     : karin
--%>
...
<html>
    ...
    <body>
        ...
        <!--contenedor-->
        <div style="width:95%; height:680px; background-color:#f3e8e8ab; margin:0 auto; margin-top:110px; padding: 10px">
            
            <br><br>
            <h1 style="position: relative; top: -10px; left: 800px;">Clasificación</h1>
            ...
            <div class="container">
                <div>
                    ...
                    <tbody>
                        <%
                        st = conexion.prepareStatement("select id_clasificacion, nombre from clasificacion");
                        rs = st.executeQuery();
                        while (rs.next()) 
                        {
                        %>
                        <tr>
                            <td><center><%=rs.getString("id_clasificacion")%></center></td>
                        ...
                        <div class="col-md-7">
                            <div class="form-group" >
                                ...
                                <div align="center" class="input-group">
                                   ...
                                   placeholder="Ingresa el nombre del tipo de clasificación">
